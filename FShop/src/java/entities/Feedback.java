...
@NamedQueries({
    ...
    , @NamedQuery(name = "Feedback.findByDescriptions", query = "SELECT f FROM Feedback f WHERE f.descriptions = :descriptions")})
public class Feedback implements Serializable {
    ...
    public Feedback(Integer id, String descriptions) {
        this.id = id;
